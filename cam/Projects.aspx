<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="Projects.aspx.cs" Inherits="Services" %>
    ...
    <div id="carousel-example-generic" class="carousel slide bg-ab-slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <asp:ObjectDataSource ID="odsBannerService" runat="server" SelectMethod="ProjectCategoryImageSelectAll" TypeName="TLLib.ProjectCategoryImage">
                <SelectParameters>
                    <asp:QueryStringParameter QueryStringField="pri" DefaultValue="4" Name="ProjectCategoryID" Type="String"></asp:QueryStringParameter>
            ...
            <div class="menu-right">
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryNameCam")) + "-"+(Eval("CountProject").ToString() == "0"?"pri":"prid")+"-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryNameCam") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
                    <asp:ObjectDataSource ID="odsServiceCategory" runat="server" SelectMethod="ProjectCategorySelectAll" TypeName="TLLib.ProjectCategory">
                        <SelectParameters>
                            <asp:QueryStringParameter QueryStringField="pri" DefaultValue="4" Name="parentID" Type="Int32"></asp:QueryStringParameter>
