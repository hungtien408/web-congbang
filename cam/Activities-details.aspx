<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="Activities-details.aspx.cs" Inherits="News_details" %>
            ...
            <div class="menu-news">
                <ul>
                    <asp:Repeater ID="RepeaterSame" runat="server" DataSourceID="odsSame" EnableViewState="false">
                        <ItemTemplate>
                            <li><a href="<%# SiteCode.progressTitle(Eval("ProjectTitleCam")) + "-acd-" + Eval("ProjectID") + ".aspx" %>"><%# Eval("ProjectTitleCam") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
