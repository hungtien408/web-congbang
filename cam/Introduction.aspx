<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="Introduction.aspx.cs" Inherits="Introduction" %>
                ...
                <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                    <ItemTemplate>
                        <div class="item">
                            ...
                            <div class="carousel-caption main-wrap">
                                <%# Eval("ContentCam") %>
                            </div>
                        </div>
                    </ItemTemplate>
