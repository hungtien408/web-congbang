<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="Services" %>
            ...
            <div class="menu-right">
                ...
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryNameCam")) + "-pi-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryNameCam") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
