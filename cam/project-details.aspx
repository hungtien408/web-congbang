<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="project-details.aspx.cs" Inherits="project_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main_content" runat="Server">
            ...
            <div class="menu-right PJde-menu">
                <ul>
                    ...
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectTitleCam")) + "-prd-" + Eval("ProjectID") + ".aspx" %>'><%# Eval("ProjectTitleCam") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <div class="img-project owl-carousel">
        <asp:Repeater ID="RepeaterSame" runat="server" DataSourceID="odsProjectSame" EnableViewState="false">
            <ItemTemplate>
                <div class="item">
                    <a href="<%# SiteCode.progressTitle(Eval("ProjectTitleCam")) + "-prd-" + Eval("ProjectID") + ".aspx" %>">
