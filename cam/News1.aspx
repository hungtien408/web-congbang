<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="News1.aspx.cs" Inherits="Services" %>
            ...
            <div class="menu-news">
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryNameCam")) + "-"+(Eval("CountProject").ToString() == "0"?"ni":"nid")+"-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryNameCam") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
