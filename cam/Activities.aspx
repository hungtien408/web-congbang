<%@ Page Title="" Language="C#" MasterPageFile="~/cam/site.master" AutoEventWireup="true" CodeFile="Activities.aspx.cs" Inherits="Services" %>
            ...
            <div class="menu-right">
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryNameCam")) + "-"+(Eval("CountProject").ToString() == "0"?"aci":"acid")+"-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryNameCam") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
