<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="Thermall-insulation.aspx.cs" Inherits="Thermall_insulation" %>
    ...
    <div class="main-wrap">
        ...
        <div class="right">
            <div class="menu-right">
                <ul>
                    <li><a href="#">Internal & External <br />Duct Insulation</a></li>
                    <li><a href="#">Acoustic Duct Linning</a></li>
                    <li><a href="Hot-and-Cold.aspx">Hot & Cold Pipe Insulation</a></li>
                    <li><a href="#">HRoof & Wall Insulation</a></li>
                </ul>
            </div>
        </div>
    </div>
