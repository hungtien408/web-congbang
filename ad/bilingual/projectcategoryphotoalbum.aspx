<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="projectcategoryphotoalbum.aspx.cs" Inherits="ad_single_projectcategoryphotoalbum" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel runat="server" ID="RadAjaxPanel1" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadListView runat="server" ID="RadListView1" DataSourceID="ObjectDataSource1"
            AllowPaging="True" DataKeyNames="ProjectCategoryImageID" OverrideDataSourceControlSorting="True"
            ...
            <ItemTemplate>
                ...
                <fieldset style="float: left; margin: 5px 5px 50px 5px; padding: 2px 2px 2px 2px; position: relative; background: #eeeeee"
                    ...
                    <%--<img alt="" src='<%# "~/res/projectcategory/album/" + Eval("ImageName") %>' width='<%#ImageWidth %>'
                            height='<%#ImageHeight %>' title="Click xem ảnh lớn" runat="server" />--%>
                    <a href='<%# "~/res/projectcategory/album/" + Eval("ImageName") %>' runat="server" class="lightbox">
                        <asp:RadBinaryImage Style="cursor: pointer; display: block;" runat="server" ID="RadBinaryImage1"
                            ImageUrl='<%# "~/res/projectcategory/album/" + Eval("ImageName") %>' Height='<%#ImageHeight %>'
                    ...
                    <table style="bottom: -25px; position: absolute; width: <%#ImageHeight.Value %>px; border-collapse: collapse; font-size: 8pt"
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:RadNumericTextBox ID="txtPriority" runat="server" Width="50px" Height="17px"
            ...
            <InsertItemTemplate>
                <asp:Panel ID="Panel2" runat="server" DefaultButton="lnkUpdate">
                    <h3 class="searchTitle clear">Thêm Ảnh Mới</h3>
                    <table class="search">
                        <tr>
            ...
            <EditItemTemplate>
                <asp:HiddenField ID="hdnProjectCategoryImageID" runat="server" Value='<%# Eval("ProjectCategoryImageID") %>' />
                <asp:HiddenField ID="hdnImageName" runat="server" Value='<%# Eval("ImageName") %>' />
                <asp:Panel ID="Panel2" runat="server" DefaultButton="lnkUpdate">
                    ...
                    <table class="search">
                        <tr>
                            ...
                            <td rowspan="5" valign="top">
                                <asp:RadBinaryImage Style="display: block;" runat="server" ID="RadBinaryImage1" ImageUrl='<%# "~/res/projectcategory/album/" + Eval("ImageName") %>'
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
            SelectMethod="ProjectCategoryImageSelectAll" TypeName="TLLib.ProjectCategoryImage" UpdateMethod="ProjectCategoryImageUpdate" DeleteMethod="ProjectCategoryImageDelete">
            <DeleteParameters>
                <asp:Parameter Name="ProjectCategoryImageID" Type="String"></asp:Parameter>
            </DeleteParameters>
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="" Name="ProjectCategoryID" QueryStringField="PI" Type="String" />
                <asp:Parameter Name="IsAvailable" Type="String" />
                <asp:Parameter Name="Priority" Type="String" />
                <asp:Parameter DefaultValue="True" Name="SortByPriority" Type="String" />
                <asp:Parameter Name="IsBackground" Type="String" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="ProjectCategoryImageID" Type="String" />
                ...
                <asp:Parameter Name="DescripttionCam" Type="String" />
