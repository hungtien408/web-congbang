<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="projectcategorydownload.aspx.cs" Inherits="ad_single_projectcategorydownload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <fieldset>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProjectCategorySelectOne"
            TypeName="TLLib.ProjectCategory">
            <SelectParameters>
                <asp:QueryStringParameter Name="ProjectCategoryID" QueryStringField="PI" Type="String" />
            </SelectParameters>
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProjectCategoryDownloadID">
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProjectCategoryDownloadID" SortExpression="ProjectCategoryDownloadID">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridBoundColumn HeaderText="Tiêu đề(Tiếng Campuchia)" SortExpression="FileNameCam"
                        DataField="FileNameCam" />
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProjectCategoryDownloadID" runat="server" Value='<%# Eval("ProjectCategoryDownloadID") %>' />
                                        <asp:HiddenField ID="hdnLinkDownload" runat="server" Value='<%# Eval("LinkDownload") %>' />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFileNameCam" runat="server" Width="500px" Text='<%# Bind("FileNameCam") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left">
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectCategoryCategorySelectAll"
                                TypeName="TLLib.ProjectCategoryCategory"></asp:ObjectDataSource>
                        </asp:Panel>
                        <asp:RadInputManager ID="RadInputManager1" runat="server">
                            <asp:NumericTextBoxSetting AllowRounding="False" Culture="vi-VN" EmptyMessage="Thứ tự ..."
                                Type="Number" DecimalDigits="0">
                            ...
                            <asp:TextBoxSetting EmptyMessage="Tiêu đề(Cam) ...">
                                <TargetControls>
                                    <asp:TargetInput ControlID="txtFileNameCam" />
                                </TargetControls>
                            </asp:TextBoxSetting>
                        </asp:RadInputManager>
                    </FormTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectCategoryDownloadSelectAll"
            TypeName="TLLib.ProjectCategoryDownload" DeleteMethod="ProjectCategoryDownloadDelete" InsertMethod="ProjectCategoryDownloadInsert"
            UpdateMethod="ProjectCategoryDownloadUpdate">
            <DeleteParameters>
                <asp:Parameter Name="ProjectCategoryDownloadID" Type="String" />
            </DeleteParameters>
            <InsertParameters>
                <asp:QueryStringParameter Name="ProjectCategoryID" QueryStringField="PI" Type="String" />
                <asp:Parameter Name="FileName" Type="String" />
                <asp:Parameter Name="FileNameEn" Type="String" />
                <asp:Parameter Name="FileNameCam" Type="String" />
