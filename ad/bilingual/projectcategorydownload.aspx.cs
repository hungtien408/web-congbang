...
public partial class ad_single_projectcategorydownload : System.Web.UI.Page
{
    ...
    void DeleteFile(string strFileName)
    {
        ...
        {
            var strFilePath = Server.MapPath("~/res/projectcategory/download/" + strFileName);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            string ProjectCategoryDownloadID, Priority, IsAvailable;
            var oProjectCategoryDownload = new ProjectCategoryDownload();

            foreach (GridDataItem item in RadGrid1.Items)
            {
                ProjectCategoryDownloadID = item.GetDataKeyValue("ProjectCategoryDownloadID").ToString();
                Priority = ((RadNumericTextBox)item.FindControl("txtPriority")).Text.Trim();
                IsAvailable = ((CheckBox)item.FindControl("chkIsAvailable")).Checked.ToString();

                oProjectCategoryDownload.ProjectCategoryDownloadQuickUpdate(
                    ProjectCategoryDownloadID,
                    IsAvailable,
                    Priority
                );
            }
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            else
            {
                ...
                var strOldImagePath = Server.MapPath("~/res/projectcategory/download/" + strOldLinkDownload);
            ...
            if (!string.IsNullOrEmpty(strLinkDownload))
            {
                string strSavePath = Server.MapPath("~/res/projectcategory/download/" + strLinkDownload);
