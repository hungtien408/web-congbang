<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="Projects.aspx.cs" Inherits="Services" %>
            ...
            <div class="menu-right">
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryNameEn")) + "-"+(Eval("CountProject").ToString() == "0"?"pri":"prid")+"-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryNameEn") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
