<%@ Page Title="" Language="C#" MasterPageFile="~/vi/site.master" AutoEventWireup="true" CodeFile="Activities-details.aspx.cs" Inherits="News_details" %>
            ...
            <div class="menu-news">
                <ul>
                    <asp:Repeater ID="RepeaterSame" runat="server" DataSourceID="odsSame" EnableViewState="false">
                        <ItemTemplate>
                            <li><a href="<%# SiteCode.progressTitle(Eval("ProjectTitle")) + "-acd-" + Eval("ProjectID") + ".aspx" %>"><%# Eval("ProjectTitle") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
