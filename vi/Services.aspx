<%@ Page Title="" Language="C#" MasterPageFile="~/vi/site.master" AutoEventWireup="true" CodeFile="Services.aspx.cs" Inherits="Services" %>
            ...
            <div class="menu-right">
                ...
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryName")) + "-si-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryName") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
