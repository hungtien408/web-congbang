<%@ Page Title="" Language="C#" MasterPageFile="~/vi/site.master" AutoEventWireup="true" CodeFile="Projects.aspx.cs" Inherits="Services" %>
            ...
            <div class="menu-right">
                <ul>
                    <asp:Repeater ID="RepeaterServiceCategory" runat="server" DataSourceID="odsServiceCategory">
                        <ItemTemplate>
                            <li><a href='<%# SiteCode.progressTitle(Eval("ProjectCategoryName")) + "-"+(Eval("CountProject").ToString() == "0"?"pri":"prid")+"-" + Eval("ProjectCategoryID") + ".aspx" %>'><%# Eval("ProjectCategoryName") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
