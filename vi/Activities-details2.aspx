<%@ Page Title="" Language="C#" MasterPageFile="~/vi/site.master" AutoEventWireup="true" CodeFile="Activities-details2.aspx.cs" Inherits="News_details" %>
            ...
            <div class="menu-news">
                <ul>
                    <asp:Repeater ID="RepeaterSame" runat="server" DataSourceID="odsSame" EnableViewState="false">
                        <ItemTemplate>
                            <li><a href="<%# SiteCode.progressTitle(Eval("ProjectTitle")) + "-acid-" + Eval("ProjectID") + ".aspx" %>"><%# Eval("ProjectTitle") %></a></li>
                        </ItemTemplate>
                    </asp:Repeater>
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                ...
                                jwplayer('jwplayer1').setup({
                                    ...
                                    flashplayer: "/vi/assets/js/jwplayer.flash.swf",
                                    height: 160,
                                    width: 240,
                                    dock: true,
                                    //autostart: true,
